 ...
 */
public class JDeferredJavaFXActionManager extends JavaFXActionManager {
    private final PromiseManager promiseManager;

    @Inject
    public JDeferredJavaFXActionManager(@Nonnull GriffonApplication application, @Nonnull ActionFactory actionFactory, @Nonnull ActionMetadataFactory actionMetadataFactory, @Nonnull PromiseManager promiseManager) {
