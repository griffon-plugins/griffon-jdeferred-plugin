...
public class JDeferredJavaLanternaManager extends LanternaActionManager {
    ...
    @Inject
    public JDeferredJavaLanternaManager(@Nonnull GriffonApplication application, @Nonnull ActionFactory actionFactory, @Nonnull ActionMetadataFactory actionMetadataFactory, @Nonnull PromiseManager promiseManager) {
