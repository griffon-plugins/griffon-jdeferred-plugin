...
public class JDeferredActionManager extends DefaultActionManager {
    ...
    @Inject
    public JDeferredActionManager(@Nonnull GriffonApplication application, @Nonnull ActionFactory actionFactory, @Nonnull ActionMetadataFactory actionMetadataFactory, @Nonnull PromiseManager promiseManager) {
