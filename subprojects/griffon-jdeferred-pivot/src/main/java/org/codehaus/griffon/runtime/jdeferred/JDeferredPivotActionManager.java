 ...
 */
public class JDeferredPivotActionManager extends PivotActionManager {
    private final PromiseManager promiseManager;

    @Inject
    public JDeferredPivotActionManager(@Nonnull GriffonApplication application, @Nonnull ActionFactory actionFactory, @Nonnull ActionMetadataFactory actionMetadataFactory, @Nonnull PromiseManager promiseManager) {
